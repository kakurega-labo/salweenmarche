...
                                <option value="">都道府県を選択してください</option>
                    ...
                    <div class="form-section">
                        ...
                        <label class="input-field" style="text-align: left; background: var(--color-white); cursor: pointer; display: flex; align-items: center;">
                    ...
                    <a href="#" class="back-to-shop back-btn-bottom">
                        <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="vertical-align: middle; filter: invert(1);">
